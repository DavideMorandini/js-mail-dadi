...
/* -  Generare un array che contenga la lista di tutti i numeri da 1 a 6

    -  Generare un numero random da 1 a 6 sia per il giocatore sia per il computer (Math.floor( ( Math.random) scrivi un qualsiasi numero arabo)
